...
var appbar =  GoogleFonts.getFont("Roboto Condensed",
  color: Colors.black,
  fontSize: 18, fontWeight: FontWeight.w600,
);
var button =  GoogleFonts.getFont("Roboto Condensed", fontSize: 18, fontWeight: FontWeight.w600, color: Colors.white,);
...
var colors = Color(0xff2FB8A6);
var genr = GoogleFonts.getFont("Roboto Condensed", fontSize: 18, fontWeight: FontWeight.w600, color: Colors.black,);
